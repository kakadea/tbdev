...
'ok_success' => "Signup successful!",
	...
	'ok_pending_title' => "Signup pending",
	'ok_pending_body' => "<p>Your account was created but could not be confirmed automatically because the server has no working email transport.</p><p>In this laboratory, ask the SysOp to confirm the account, or enable the explicit lab-only auto-confirmation setting. The account will not appear in the public user list until it is confirmed.</p>",
...
'ok_read_rules' => "<p>Before you start using %s we urge you to read the <a href='rules.php'><b>RULES</b></a>.</p>\n",
